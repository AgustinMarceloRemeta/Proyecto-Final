...
{
    public readonly static string textInvalid = "Ingrese un texto valido";
    public readonly static string valueInvalid = "Ingrese un numero valido";
    public readonly static string numberNegative = "La nota no puede ser negativa";
